...
public class dn4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dn4);
        ...
        submit.setOnClickListener(v -> {
            ...
            if (selectedId == -1) {
                new AlertDialog.Builder(dn4.this)
                ...
                Intent intent = new Intent(dn4.this, dn5.class);
