...
public class got4 extends AppCompatActivity {

    TextView question;
    RadioGroup rg;
    Button submit;

    int correctAnswerId = R.id.radioButtonA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_got4);
        ...
        submit.setOnClickListener(v -> {
            ...
            if (selectedId == -1) {
                new AlertDialog.Builder(got4.this)
                ...
                Intent intent = new Intent(got4.this, gotresult.class);
