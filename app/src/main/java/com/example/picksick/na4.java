...
public class na4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_na4);
        ...
        submit.setOnClickListener(v -> {
            ...
            if (selectedId == -1) {
                new AlertDialog.Builder(na4.this)
                ...
                Intent intent = new Intent(na4.this, n_result.class);
